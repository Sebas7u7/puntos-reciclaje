...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="/puntos-reciclaje/vista/Usuario/indexUsuario.php">
            <img src="/puntos-reciclaje/assets/logo.png" alt="Logo"> <!-- Reemplaza con tu logo -->
            <span class="ms-2 d-none d-sm-inline">Puntos de Reciclaje</span>
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/puntos-reciclaje/vista/Usuario/indexUsuario.php">
                        <i class="bi bi-trash3"></i> Puntos de reciclaje
                    </a>
                </li>
                <li class="nav-item">
